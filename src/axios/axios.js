...
const api = axios.create({
  baseURL: "https://projectapi-production-791d.up.railway.app/api",
  timeout: 10000,
  headers: {
...
const sheets = {
  ...
  cancelOrderByAdmin: (orderId) => api.delete(`orders/admin/cancel/${orderId}`),
  deleteOrderByAdmin: (orderId) => api.delete(`orders/admin/${orderId}`),
